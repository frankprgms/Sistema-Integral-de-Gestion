...
# Definición del servicio especializado en la reserva de salas, heredando de la clase Service

class Room_Reservation_Service(Service):
    def __init__(self,service_id,client,base_fee,equipment_name,rental_days):
        ...
        super().__init__(service_name="Room Reservation",service_id=service_id,client=client,base_fee=base_fee)
